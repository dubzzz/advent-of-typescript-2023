...
> = TStack extends [TElement, ...(infer TOthers)] ? Count<TOthers, TElement, [TElement, ...TAcc]> : TStack extends [unknown, ...(infer TOthers)] ? Count<TOthers, TElement, TAcc> : TAcc['length'];
